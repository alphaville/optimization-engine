...
extern "C" {
    ...
    fn preconditioning_w_cost_function_{{ meta.optimizer_name }}(
        arg: *const *const c_double,
        casadi_results: *mut *mut c_double,
    ) -> c_int;
    fn preconditioning_w1_function_{{ meta.optimizer_name }}(
        arg: *const *const c_double,
        casadi_results: *mut *mut c_double,
    ) -> c_int;
    fn preconditioning_w2_function_{{ meta.optimizer_name }}(
        arg: *const *const c_double,
        casadi_results: *mut *mut c_double,
    ) -> c_int;
} // END of extern C
...
/// Consume preconditioning W_COST, which has been generated by CasADi
///
/// This is a wrapper function
///
/// ## Arguments
...
/// Consume preconditioning w1, which has been generated by CasADi
///
/// This is a wrapper function
///
/// ## Arguments
...
pub fn preconditioning_w1(
    ...
    let arguments = &[u.as_ptr(), static_params.as_ptr()];
    let constraints = &mut [w1.as_mut_ptr()];

    unsafe {
         preconditioning_w1_function_{{ meta.optimizer_name }}(
            arguments.as_ptr(),
            constraints.as_mut_ptr()
        ) as i32
    }
...
/// Consume preconditioning w2, which has been generated by CasADi
///
/// This is a wrapper function
///
/// ## Arguments
...
pub fn preconditioning_w2(
    ...
    assert!(
        w2.len() == NUM_CONSTRAINTS_TYPE_PENALTY || NUM_CONSTRAINTS_TYPE_PENALTY == 0,
        "Incompatible dimension of `w2` (result)"
    );

    let arguments = &[u.as_ptr(), static_params.as_ptr()];
    let constraints = &mut [w2.as_mut_ptr()];

    unsafe {
         preconditioning_w2_function_{{ meta.optimizer_name }}(
            arguments.as_ptr(),
            constraints.as_mut_ptr()
        ) as i32
    }
